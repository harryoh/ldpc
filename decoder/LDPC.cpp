...
#include "../utility_function/sha256.hpp"
...
bool LDPC::LDPC_Decoding()
{
  ...
  for (int i = 0; i < this->block_length; i++)
  {
    ...
    this->LRft[i] = log10((1 - this->cross_over_probability) / (this->cross_over_probability))*(double)(this->input_word[i] * 2 - 1);//infinity_test
  }
